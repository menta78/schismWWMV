...
!**********************************************************************
      ...
      ! The history output
      !
      IF ( (MAIN%TMJD .GE. OUT_HISTORY%TMJD-tolD) .AND. (MAIN%TMJD .LE. OUT_HISTORY%EMJD+tolD)) THEN
      ...
      ! The station output
      !
      IF ( (MAIN%TMJD .GE. OUT_STATION%TMJD-tolD) .AND. (MAIN%TMJD .LE. OUT_STATION%EMJD+tolD)) THEN
      ...
      !
      IF (LHOTF) THEN
        IF ( (MAIN%TMJD .GE. HOTF%TMJD-tolD) .AND. (MAIN%TMJD .LE. HOTF%EMJD+tolD)) THEN
...
!        Print *, '2: OUT_BOUC % TMJD=', OUT_BOUC % TMJD, ' OUT_BOUC % EMJD=', OUT_BOUC%EMJD
        IF ( (MAIN%TMJD .GE. OUT_BOUC%TMJD-tolD) .AND. (MAIN%TMJD .LE. OUT_BOUC%EMJD+tolD)) THEN
