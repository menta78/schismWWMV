...
!*                                                                    *
!**********************************************************************
      SUBROUTINE DEEP_WATER(IP, ACLOC, PHI, DPHIDN, SSINE, DSSINE, SSDS, DSSDS, SSNL4, DSSNL4, SSINL)
         USE DATAPOOL
         IMPLICIT NONE
...
#endif
           CALL ST4_PRE(IP, ACLOC, PHI, DPHIDN, SSINE, DSSINE, SSDS, DSSDS, SSNL4, DSSNL4, SSINL)
         ELSE IF (ISOURCE == 2) THEN
#ifdef DEBUG_SOURCE_TERM
           WRITE(STAT%FHNDL,*) 'DOING WAM'
#endif
           CALL ECMWF_PRE(IP, ACLOC, PHI, DPHIDN, SSINE, DSSINE, SSDS, DSSDS, SSNL4, DSSNL4, SSINL)
#ifdef DEBUG_SOURCE_TERM
...
#endif
           CALL CYCLE3_PRE(IP, ACLOC, PHI, DPHIDN, SSINE, DSSINE, SSDS, DSSDS, SSNL4, DSSNL4, SSINL)
         ENDIF
