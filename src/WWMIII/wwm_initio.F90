...
!      DMIN = DMIN_SCHISM
      ...
      CALL SETSHALLOW
      CALL SET_HMAX
      CALL Print_SumAC2("After INITIATE_WAVE_PARAMETER")
      ...
      CALL Print_SumAC2("After WWM_OUTPUT")
      IF (LWXFN) THEN
        CALL WRINPGRD_XFN
      ELSE IF(LWSHP) THEN
        CALL WRINPGRD_SHP
