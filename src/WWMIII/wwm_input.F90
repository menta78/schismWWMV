...
!**********************************************************************
     ...
     &      USE_EXACT_FORMULA_SPHERICAL_AREA, EXPORT_GRID_WW3
     ...
     &      HACK_HARD_SET_IOBP,                                         &
     &      NETCDF_IN_FILE, EXPORT_BOUC_WW3, EXPORT_BOUC_DELTC
     ...
     &      MULTIPLE_IN, EXPORT_WIND_WW3, EXPORT_WIND_DELTC
