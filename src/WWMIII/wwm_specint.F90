...
!**********************************************************************
      ...
      IF (IP .eq. TESTNODE) THEN
         ...
         WRITE(740+myrank,*) 'BOTTOM FRICTION(SSBF) =', SUM(SSBF),  MINVAL(SSBF),  MAXVAL(SSBF)
         WRITE(740+myrank,*) 'BOTTOM FRICTION(DSSBF)=', SUM(DSSBF), MINVAL(DSSBF), MAXVAL(DSSBF)
         ...
         WRITE(740+myrank,*) 'TOTAL SOURCE TERMS(IMATR)=', SUM(IMATRA), MINVAL(IMATRA), MAXVAL(IMATRA)
         WRITE(740+myrank,*) 'TOTAL SOURCE TERMS(IMATR)=', SUM(IMATDA), MINVAL(IMATDA), MAXVAL(IMATDA)
      END IF
#endif
