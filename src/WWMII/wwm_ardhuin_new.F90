...
!        WRITE(5001,*) SSWELLF
        ...
        ALLOCATE(SATWEIGHTS(2*SDSNTH+1,MTH)); SATWEIGHTS = 0._rkind
        ALLOCATE(CUMULW(MK*MTH,MK*MTH)); CUMULW = 0._rkind
        ALLOCATE(DCKI(NKHS,NKD)); DCKI = 0._rkind
        ALLOCATE(LLWS(NSPEC)); LLWS = .FALSE.
        ALLOCATE(QBI(NKHS,NKD)); QBI = 0._rkind
