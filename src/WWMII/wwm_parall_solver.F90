...
!**********************************************************************
      ...
      allocate(LocalColor % ISbegin(MSCeffect), LocalColor % ISend(MSCeffect), LocalColor % ISlen(MSCeffect), stat=istat)
...
!**********************************************************************
      ...
      DO IP=1,MNP
        DO IS=1,MSC
          DO ID=1,MDC
            AC2(IP,IS,ID)=MAX(ZERO, SolDat%AC2(IP,IS,ID))*MyREAL(IOBPD(ID,IP))
          END DO
        END DO
      END DO
# ifdef DEBUG
