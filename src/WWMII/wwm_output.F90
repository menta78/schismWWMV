...
!
         ...
         IF (myrank == 0) THEN
           ...
           WRITE(OUT%FHNDL+2)  (SNGL(CURR_GLOBAL(IP,1)), SNGL(CURR_GLOBAL(IP,2)), SNGL(CURR_GLOBAL(IP,5)), IP = 1, NP_GLOBAL)
           FLUSH(OUT%FHNDL+2)
           ...
           WRITE(OUT%FHNDL+5)  (SNGL(CURR_GLOBAL(IP,1)), SNGL(CURR_GLOBAL(IP,2)), SNGL(CURR_GLOBAL(IP,10))  , IP = 1, NP_GLOBAL)
           FLUSH(OUT%FHNDL+5)
