...
!**********************************************************************
      SUBROUTINE OUTPUT_HISTORY_AND_STATION
        USE DATAPOOL
        IMPLICIT NONE
        IF ( (MAIN%TMJD .GE. OUT_HISTORY%TMJD-1.E-8) .AND.              &
     &       (MAIN%TMJD .LE. OUT_HISTORY%EMJD)) THEN
          WRITE(STAT%FHNDL,'("+TRACE...",A,4F15.4)')                    &
     &          'WRITING OUTPUT INTERNAL TIME', RTIME, MAIN%TMJD,       &
     &          OUT_HISTORY%TMJD-1.E-8, OUT_HISTORY%EMJD
