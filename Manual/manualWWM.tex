...
\setmarginsrb{2cm}{2cm}{2cm}{2cm}{1cm}{1cm}{0pt}{0pt}
...
\item {\tt CART2LATLON} (logical): Convert a Cartesian grid to a lat/lon grid. Default is false. Use it only if you are sure of what you are doing.
\item {\tt LATLON2CART} (logical): Convert a lat/lon grid to a Cartesian grid. Default is false. Use it only if you are sure of what you are doing.
...
\item {\tt OUTSTYLE} (string): type of output used. Possible values:
  \begin{itemize}
  \item {\tt ``NO''}: No station output is done.
  \item {\tt ``NC''}: netCDF style of data output.
