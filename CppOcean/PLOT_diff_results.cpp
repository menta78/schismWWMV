...
# 126 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_diff_results.cpp"
return LCoeff;
}
...
# 2995 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_diff_results.cpp"
template<typename T>
...
return eVal;
# 3913 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_diff_results.cpp"
}
...
double xk = X(kk);
double yk = Y(kk);
# 8924 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_diff_results.cpp"
double f1, f2, f3;
f1 = xi*(yj-Yp) + xj*(Yp-yi) + Xp*(yi-yj);
f2 = xj*(yk-Yp) + xk*(Yp-yj) + Xp*(yj-yk);
f3 = xk*(yi-Yp) + xi*(Yp-yk) + Xp*(yk-yi);
...
Compute_FE_uv_array(ePerm, TotalArr1);
