# 4 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_results.cpp"
#include <ctype.h>
#include <malloc.h>
#include <unistd.h>
#include <getopt.h>
...
# 130 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_results.cpp"
return LCoeff;
}
...
# 3010 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_results.cpp"
template<typename T>
...
return eVal;
# 3930 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_results.cpp"
}
...
double xk = X(kk);
double yk = Y(kk);
# 8985 "/home/mathieu/GIT/wwmIII/CppOcean/PLOT_results.cpp"
double f1, f2, f3;
f1 = xi*(yj-Yp) + xj*(Yp-yi) + Xp*(yi-yj);
f2 = xj*(yk-Yp) + xk*(Yp-yj) + Xp*(yj-yk);
f3 = xk*(yi-Yp) + xi*(Yp-yk) + Xp*(yk-yi);
